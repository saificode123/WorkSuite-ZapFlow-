                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link f-15 integrations"
                               href="{{ route('project-settings.index') }}?tab=integrations" role="tab"
                               aria-controls="nav-integrations"
                               aria-selected="true">@lang('modules.projects.integrations')
                            </a>
                        </div>
                    </nav>
