        ...
        <x-form id="save-project-data-form">
            <div class="bg-white rounded add-client">
                ...
                <div class="p-20 row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-forms.text
                            :fieldLabel="__('BugHerd Project ID')"
                            fieldName="bugherd_project_id"
                            fieldId="bugherd_project_id"
                            :fieldValue="$project->bugherd_project_id ?? ''"
                        />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <x-forms.text
                            :fieldLabel="__('Jira Project Key')"
                            fieldName="jira_project_key"
                            fieldId="jira_project_key"
                            :fieldValue="$project->jira_project_key ?? ''"
                            :fieldHelp="__('e.g., KAN, PROJ, TEST')"
                        />
                    </div>
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="form-group my-3">
                            ...
                            <div class="d-flex">
                                ...
                                <x-forms.radio fieldId="need_approval_by_admin-no" :fieldLabel="__('app.disable')" fieldValue="0"
                                    fieldName="need_approval_by_admin" ></x-forms.radio>
                            </div>
                        </div>
                    </div>
