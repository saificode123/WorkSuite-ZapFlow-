        ...
        <x-form id="save-data-form" method="PUT">
            <div class="add-client bg-white rounded shadow-sm">
                <h4 class="mb-0 p-20 f-21 font-weight-normal border-bottom-grey">
                    <i class="fa fa-handshake mr-2 text-primary"></i>@lang('app.serviceProvider')
                </h4>
                ...
                <div class="p-20">
                    ...
                    <h6 class="text-muted text-uppercase f-13 font-weight-bold mb-3">
                        <i class="fa fa-info-circle mr-1"></i>Provider Details
                    </h6>
                    <div class="row mb-2">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <x-forms.email fieldId="email" :fieldLabel="__('app.email')" :fieldPlaceholder="__('app.email')" fieldName="email" fieldValue="{{ $serviceProvider->email }}"></x-forms.email>
                        </div>
                        <div class="col-md-6">
