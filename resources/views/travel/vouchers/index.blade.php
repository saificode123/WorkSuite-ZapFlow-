...
@php
$addPermission = user()->permission('add_voucher');
@endphp
...
@push('scripts')
    ...
    <script>
        const showTable = () => window.LaravelDataTables["vouchers-table"].draw(true);
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.easyAjax({
                        type: 'POST', url: "{{ route('vouchers.destroy', ':id') }}".replace(':id', id),
