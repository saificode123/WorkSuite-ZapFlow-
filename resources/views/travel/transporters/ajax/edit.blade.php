        ...
        <x-form id="save-data-form" method="PUT">
            <div class="add-client bg-white rounded shadow-sm">
                ...
                <div class="p-20">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <x-forms.text fieldId="name" :fieldLabel="__('app.name')" fieldName="name" fieldRequired="true" fieldValue="{{ $transporter->name }}"></x-forms.text>
                        </div>
                        <div class="col-md-6">
                            <x-forms.text fieldId="contact_person" :fieldLabel="__('app.contactPerson')" fieldName="contact_person" fieldValue="{{ $transporter->contact_person }}"></x-forms.text>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-forms.text fieldId="phone" :fieldLabel="__('app.phone')" fieldName="phone" fieldValue="{{ $transporter->phone }}"></x-forms.text>
                        </div>
                        <div class="col-md-6">
                            <x-forms.email fieldId="email" :fieldLabel="__('app.email')" :fieldPlaceholder="__('app.email')" fieldName="email" fieldValue="{{ $transporter->email }}"></x-forms.email>
                        </div>
                        <div class="col-md-12">
                            <x-forms.textarea fieldId="vehicle_types" :fieldLabel="__('modules.transporter.vehicleTypes')" fieldName="vehicle_types">{{ $transporter->vehicle_types }}</x-forms.textarea>
                        </div>
                    </div>
                </div>
...
<script>
    $('#save-form').click(function() {
        $.easyAjax({
            url: "{{ route('transporters.update', $transporter->id) }}", container: '#save-data-form', type: "POST",
