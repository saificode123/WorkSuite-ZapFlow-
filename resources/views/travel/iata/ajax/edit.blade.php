            ...
            <div class="add-client bg-white rounded shadow-sm ct-card">
                ...
                <div class="row p-20">
                    <div class="col-md-6 mb-3 mb-md-0">
                        <x-forms.text fieldId="code" :fieldLabel="__('app.iataCode')" fieldName="code" fieldRequired="true" fieldValue="{{ $iata->code }}"></x-forms.text>
...
<script>
    ...
    // Cosmetic-only addition: character count under the code field,
    // seeded from $iata->code on load. Never trims or alters input.
    (function() {
        var $code = $('#code');
        ...
        updateHint(); // reflects $iata->code immediately
    })();
</script>