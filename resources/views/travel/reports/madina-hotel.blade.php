...
<div class="content-wrapper rpt-box">
    <div class="rpt-mast">
        <div>
            <h1><i class="fa fa-mosque mr-2 text-success"></i>{{ $city }} Hotel Check-In / Check-Out Report</h1>
    ...
    <div class="rpt-filter">
        <form method="GET" action="{{ route('travel-reports.madina-hotel') }}" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('travel-reports.madina-hotel') }}" class="btn btn-sm btn-light border ml-1"><i class="fa fa-times mr-1"></i>Reset</a>
            </div>
        </form>
    </div>
