...
<div class="content-wrapper rpt-box">
    <div class="rpt-mast">
        <div>
            <h1><i class="fa fa-plane-arrival mr-2 text-primary"></i>Arrival Report</h1>
            <p class="text-muted mb-0">Passengers Arriving in KSA — Departure Date Range</p>
        </div>
        <div>
    ...
    <div class="rpt-filter">
        <form method="GET" action="{{ route('travel-reports.arrival') }}" class="row g-2 align-items-end">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('travel-reports.arrival') }}" class="btn btn-sm btn-light border ml-1"><i class="fa fa-times mr-1"></i>Reset</a>
            </div>
        </form>
    </div>
    ...
    <div class="table-responsive">
        <table class="rpt-table">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="9" class="text-center text-muted py-4">No arrivals found for this date range.</td></tr>
                @endforelse
            </tbody>
