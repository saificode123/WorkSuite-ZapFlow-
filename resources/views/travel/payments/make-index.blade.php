...
<div class="content-wrapper">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h4 class="mb-0 font-weight-normal">@lang('modules.travelPayments.makePayments')</h4>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <div id="table-actions" class="d-flex"></div>
            @if (in_array(user()->permission('add_travel_payment'), ['all', 'added']))
                <x-forms.link-primary :link="route('travel-payments.make.create')" class="openRightModal ml-2" icon="plus">
