    ...
    <div class="col-sm-12">
        <x-form id="save-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal border-bottom-grey">@lang('app.visaCompany')</h4>
                <div class="row p-20">
                    <div class="col-md-6">
                        <x-forms.text fieldId="name" :fieldLabel="__('app.name')" fieldName="name" fieldRequired="true"></x-forms.text>
                    </div>
                    <div class="col-md-6">
                        <x-forms.text fieldId="country" :fieldLabel="__('app.country')" fieldName="country" fieldRequired="true"></x-forms.text>
                    </div>
                    <div class="col-md-6">
                        <x-forms.number fieldId="fee" :fieldLabel="__('app.fee')" fieldName="fee"></x-forms.number>
                    </div>
                    <div class="col-md-6">
                        <x-forms.number fieldId="processing_days" :fieldLabel="__('modules.visaCompany.processingDays')" fieldName="processing_days"></x-forms.number>
                    </div>
                </div>
                <x-form-actions>
...
<script>
    $('#save-form').click(function() {
        $.easyAjax({
            url: "{{ route('visa-companies.store') }}", container: '#save-data-form', type: "POST",
