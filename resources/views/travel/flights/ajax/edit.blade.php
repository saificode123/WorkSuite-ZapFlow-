...
<script>
    ...
    // Cosmetic-only addition: shows "ORIGIN → DESTINATION · dep–arr", seeded
    // from the existing flight's values on load. Never touches submission.
    (function() {
        var $origin = $('#origin');
        ...
        updateBadge(); // reflects $flight's current values immediately
    })();
</script>