        ...
        foreach ($companies as $company) {
            foreach (self::NEW_MODULES as $moduleDef) {
                ...
                $module = Module::firstOrCreate(
                    ['module_name' => $moduleName, 'company_id' => null],
                    ['description' => $moduleDef['permissions'][0]['name'] ?? '']
                );
                ...
                // Module settings for admin role
                ...
                if ($adminRole) {
                    PermissionRole::whereHas('permission', function ($q) use ($module) {
