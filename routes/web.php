...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    Route::post('project-settings/update-integrations', [ProjectSettingController::class, 'updateIntegrations'])
        ->name('project-settings.update-integrations');
    // Xero Routes
    // Xero Routes
    Route::group(['middleware' => ['auth']], function () {
    Route::get('xero', [App\Http\Controllers\XeroController::class, 'index'])->name('xero.index');
    Route::get('xero/connect', [App\Http\Controllers\XeroController::class, 'connect'])->name('xero.connect');
    Route::get('xero/callback', [App\Http\Controllers\XeroController::class, 'callback'])->name('xero.callback');
    Route::post('xero/disconnect', [App\Http\Controllers\XeroController::class, 'disconnect'])->name('xero.disconnect');
    Route::post('xero/test-connection', [App\Http\Controllers\XeroController::class, 'testConnection'])->name('xero.test');
    Route::post('xero/sync-invoice/{id}', [App\Http\Controllers\XeroController::class, 'syncInvoice'])->name('xero.sync.invoice');
    Route::get('xero/invoice-status/{id}', [App\Http\Controllers\XeroController::class, 'getInvoiceStatus'])->name('xero.invoice.status');
});
});
