...
class StoreTask extends CoreRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'priority' => 'required',
            'project_id.required' => __('messages.selectProject'), // Or your custom message
            'project_id.exists' => __('messages.projectNotFound'),
        ];
    ...
    public function messages()
    {
        ...
        return [
            'project_id.required' => __('messages.selectProject'), // ✅ ADDED: Custom message
            'project_id.exists' => __('messages.projectNotFound'), // ✅ ADDED: Custom message
