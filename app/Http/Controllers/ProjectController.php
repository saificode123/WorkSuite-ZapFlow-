...
class ProjectController extends AccountBaseController
{
    ...
    public function store(StoreProject $request)
    {
        ...
        try {
            ...
            $project->bugherd_project_id = $request->bugherd_project_id ? (int)$request->bugherd_project_id : null;
            $project->jira_project_key = $request->jira_project_key ? trim($request->jira_project_key) : null;
            ...
            if (!is_null($request->duplicateProjectID)) {
                ...
                if (!$request->filled('bugherd_project_id')) {
                    $project->bugherd_project_id = $duplicateProject->bugherd_project_id;
                }
                if (!$request->filled('jira_project_key')) {
                    $project->jira_project_key = $duplicateProject->jira_project_key;
                }
